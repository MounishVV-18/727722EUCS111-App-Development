  ...
  return (
    <div className="home">
      <section className="hero">
        <h1>Event Excellence</h1>
        <p style={{ color: 'black' }}>
  Partner with top-tier event Professionals
</p>
